package com.example.abarv.cardcounter1;
...
public class MainActivity extends AppCompatActivity {
    ...
    EditText abarvin15; // This will be a reference to our GitHub username input.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HideShow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), "Hide or show", Toast.LENGTH_LONG).show();
            }
        });
        ...
        this.abarvin15 = (EditText) findViewById(R.id.et_github_user);  // Link our github user text box.
    ...
    public void getReposClicked(View v) {
        ...
        getRepoList(abarvin15.getText().toString());
    }
}